...
<div class="materias index content">
    <?= $this->Html->link(__('Nueva Materia'), ['action' => 'add'], ['class' => 'button float-right', 'style'=>'background:#116054']) ?>
    <h3><?= __('Materias') ?></h3>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Html->link(__('Mostrar Período laboral - Profesores'), ['action' => 'disponibilidad', $materia->id], ['class' => 'button float-right', 'style'=>'background:#181271'],) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
